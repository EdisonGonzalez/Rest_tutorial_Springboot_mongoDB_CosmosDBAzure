package accenture.com.rest_tutorial_spring_mongoDB;
...
@EnableMongoRepositories(
		basePackages = "accenture.com.rest_tutorial_spring_mongoDB",
...
public class ReadPrimaryConfiguration {
	...
	public MongoTemplate readPrimaryTemplate(
		...
		final MongoDbFactory factory =
				new SimpleMongoDbFactory((MongoClient) mongo, "primarydb");
